      ...
      # -*- coding: utf-8 -*-
"""
Created on Mon Feb 22 12:46:19 2021
...
def mapping():
    ...
    maxnum = hardcord_mapping.看最晚到達時間(table,table_size,table_choose)
    print("這是自己的演算法",maxnum)
    print("這是暴力法",hardcord_mapping.hard_table(table))
